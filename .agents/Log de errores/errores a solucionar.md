...
- [ ] **Documentación:** El archivo `explicacion_comunicacion.md` indica puertos incorrectos (ej. API en 8080) que contradicen la configuración real de `application.properties` (API en 8081) y `docker-compose.yml`.
